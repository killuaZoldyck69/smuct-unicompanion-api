...
prisma/
  migrations/
    20260615114145_init/
      migration.sql
    20260616192019_init_supabase/
      migration.sql
    20260616205854_make_role_optional/
      migration.sql
    20260617104941_add_bloodgroup_enum/
      migration.sql
    20260617211327_update_teacher_profile/
      migration.sql
    20260618214326_add_academic_calendar_system/
      migration.sql
    20260619084908_update_student_profile/
      migration.sql
    20260619120704_update_noticeboard_schema/
      migration.sql
    20260620051511_update_bloodpost_schema/
      migration.sql
    20260620190256_add_alumni_complaint_field_booking_field_setting_table/
      migration.sql
    migration_lock.toml
  schema.prisma
src/
...
## File: prisma/migrations/20260615114145_init/migration.sql
```sql
-- CreateTable
CREATE TABLE "user" (
    "id" TEXT NOT NULL,
...
## File: prisma/migrations/20260616192019_init_supabase/migration.sql
```sql
/*
  Warnings:
...
## File: prisma/migrations/20260616205854_make_role_optional/migration.sql
```sql
-- AlterTable
ALTER TABLE "user" ALTER COLUMN "role" DROP NOT NULL;
```

## File: prisma/migrations/20260617104941_add_bloodgroup_enum/migration.sql
```sql
/*
  Warnings:
...
## File: prisma/migrations/20260617211327_update_teacher_profile/migration.sql
```sql
/*
  Warnings:
...
## File: prisma/migrations/20260618214326_add_academic_calendar_system/migration.sql
```sql
/*
  Warnings:
...
## File: prisma/migrations/20260619084908_update_student_profile/migration.sql
```sql
/*
  Warnings:
...
## File: prisma/migrations/20260619120704_update_noticeboard_schema/migration.sql
```sql
/*
  Warnings:
...
## File: prisma/migrations/20260620051511_update_bloodpost_schema/migration.sql
```sql
/*
  Warnings:
...
## File: prisma/migrations/20260620190256_add_alumni_complaint_field_booking_field_setting_table/migration.sql
```sql
-- CreateEnum
...
## File: src/middleware/teacher.middleware.ts
```typescript
import { Request, Response, NextFunction } from "express";
import { AppError } from "../utils/AppError";
...
## File: src/modules/alumni/alumni.controller.ts
```typescript
...
## File: src/modules/alumni/alumni.routes.ts
```typescript
...
## File: src/modules/alumni/alumni.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/alumni/alumni.service.ts
```typescript
...
## File: src/modules/blood/blood.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../utils/catchAsync";
...
## File: src/modules/blood/blood.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { validateRequest } from "../../middleware/validateRequest";
...
## File: src/modules/blood/blood.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/bus/bus.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../utils/catchAsync";
...
## File: src/modules/bus/bus.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { requireAdmin } from "../../middleware/admin.middleware";
...
## File: src/modules/bus/bus.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/bus/bus.service.ts
```typescript
import { prisma } from "../../lib/prisma";
import { AppError } from "../../utils/AppError";
...
## File: src/modules/calendar/calendar.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { requireAdmin } from "../../middleware/admin.middleware";
...
## File: src/modules/calendar/calendar.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/complaint/complaint.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../utils/catchAsync";
...
## File: src/modules/complaint/complaint.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { requireAdmin } from "../../middleware/admin.middleware";
...
## File: src/modules/complaint/complaint.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/complaint/complaint.service.ts
```typescript
import { prisma } from "../../lib/prisma";
import { AppError } from "../../utils/AppError";
import {
...
## File: src/modules/directory/directory.service.ts
```typescript
import { prisma } from "../../lib/prisma";
...
## File: src/modules/event/event.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { requireAdmin } from "../../middleware/admin.middleware";
...
## File: src/modules/event/event.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/field/field.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../utils/catchAsync";
...
## File: src/modules/field/field.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { requireAdmin } from "../../middleware/admin.middleware";
...
## File: src/modules/field/field.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/field/field.service.ts
```typescript
import { prisma } from "../../lib/prisma";
import { AppError } from "../../utils/AppError";
...
## File: src/modules/forum/forum.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { validateRequest } from "../../middleware/validateRequest";
...
## File: src/modules/forum/forum.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/hub/assessments/assessments.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../../utils/catchAsync";
...
## File: src/modules/hub/assessments/assessments.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/hub/content/content.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../../utils/catchAsync";
...
## File: src/modules/hub/content/content.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../../middleware/auth.middleware";
import { validateRequest } from "../../../middleware/validateRequest";
...
## File: src/modules/hub/content/content.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/hub/content/content.service.ts
```typescript
import { prisma } from "../../../lib/prisma";
...
## File: src/modules/hub/resources/resources.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../../utils/catchAsync";
...
## File: src/modules/hub/resources/resources.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../../middleware/auth.middleware";
import { validateRequest } from "../../../middleware/validateRequest";
...
## File: src/modules/hub/resources/resources.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/hub/resources/resources.service.ts
```typescript
import { prisma } from "../../../lib/prisma";
import { verifyHubRole } from "../hub.service";
...
## File: src/modules/hub/reviews/reviews.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../../utils/catchAsync";
...
## File: src/modules/hub/reviews/reviews.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../../middleware/auth.middleware";
import { validateRequest } from "../../../middleware/validateRequest";
...
## File: src/modules/hub/reviews/reviews.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/notice/notice.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { requireAdmin } from "../../middleware/admin.middleware";
...
## File: src/modules/teacher/teacher.controller.ts
```typescript
import { Request, Response } from "express";
...
## File: src/modules/teacher/teacher.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { requireAdmin } from "../../middleware/admin.middleware";
...
## File: src/modules/teacher/teacher.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/blood/blood.service.ts
```typescript
import { prisma } from "../../lib/prisma";
import { AppError } from "../../utils/AppError";
import {
...
## File: src/modules/forum/forum.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../utils/catchAsync";
...
## File: src/modules/forum/forum.service.ts
```typescript
import { prisma } from "../../lib/prisma";
import { AppError } from "../../utils/AppError";
import {
...
## File: src/modules/hub/assessments/assessments.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../../middleware/auth.middleware";
import { validateRequest } from "../../../middleware/validateRequest";
...
## File: src/modules/hub/assessments/assessments.service.ts
```typescript
import { prisma } from "../../../lib/prisma";
import { verifyHubRole } from "../hub.service";
import { AppError } from "../../../utils/AppError";
...
## File: src/modules/hub/reviews/reviews.service.ts
```typescript
import { prisma } from "../../../lib/prisma";
import { verifyHubRole } from "../hub.service";
import { AppError } from "../../../utils/AppError";
...
## File: src/modules/hub/hub.controller.ts
```typescript
import { Request, Response } from "express";
import { catchAsync } from "../../utils/catchAsync";
...
## File: src/modules/hub/hub.routes.ts
```typescript
import { Router } from "express";
import { requireAuth } from "../../middleware/auth.middleware";
import { validateRequest } from "../../middleware/validateRequest";
...
## File: src/modules/hub/hub.schema.ts
```typescript
import { z } from "zod";
...
## File: src/modules/hub/hub.service.ts
```typescript
import { prisma } from "../../lib/prisma";
import { AppError } from "../../utils/AppError";
...
## File: src/modules/teacher/teacher.service.ts
```typescript
import { auth } from "../../lib/auth";
...
## File: src/modules/student/student.schema.ts
```typescript
import { z } from "zod";
...
```json
{
  "name": "sumct-unicompanion-api",
  "version": "1.0.0",
  "description": "",
  "main": "index.js",
  "type": "module",
  "scripts": {
    "build": "prisma generate && tsup src/server.ts --format esm --clean",
    "start": "node dist/server.js",
    "dev": "tsx watch src/server.ts",
    "seed": "tsx src/scripts/admin-seed.ts"
  },
  "keywords": [],
  "author": "",
  "license": "ISC",
...
model AcademicCalendar {
  ...
  events            CalendarEvent[] // 👈 This connects the events
  createdAt         DateTime        @default(now())
}
